...
def topic_modeling(file_name):
    ...
    # Save results
    df.to_csv(file_name + "_topic_modeling.csv", index=False, encoding="utf-8")
    print(f"✅ Topic modeling results saved to {file_name}_topic_modeling.csv")

if __name__ == "__main__":
    topic_modeling("tr_processed_data")
    topic_modeling("us_processed_data")
