...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in morphology_pb2_grpc.py depends on'
...
def add_MorphologyServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('zemberek.morphology.MorphologyService', rpc_method_handlers)
...
class MorphologyService(object):
    ...
    def AnalyzeSentence(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/zemberek.morphology.MorphologyService/AnalyzeSentence',
            morphology__pb2.SentenceAnalysisRequest.SerializeToString,
            morphology__pb2.SentenceAnalysisProto.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def AnalyzeWord(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/zemberek.morphology.MorphologyService/AnalyzeWord',
            morphology__pb2.WordAnalysisRequest.SerializeToString,
            morphology__pb2.WordAnalysisProto.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
